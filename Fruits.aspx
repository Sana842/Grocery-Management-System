...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div style="width: 120px">
        <fieldset class="auto-style3">
            ...
            <asp:DataList runat="server" ID="gvProduct" RepeatDirection="Horizontal" RepeatColumns="4" Height="500px" OnSelectedIndexChanged="gvProduct_SelectedIndexChanged" Width="1437px">
                <ItemTemplate>
